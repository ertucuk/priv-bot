...
module.exports = async function guildUpdate(client, guild, audit, member, changes) {
  ...
  if (safeMode && !safeMode.isWarn) await punish(client, member, safeMode.punishType, 'Sunucu Güncellendi!');
  else if (!safeMode) await punish(client, member, 3, 'Sunucu Güncellendi!');
};